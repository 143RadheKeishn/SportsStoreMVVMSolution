namespace SportsStoreDomailLibrary.DataContexts.SportsStoreMigrations
{
   using Entities;
   using System;
   ...
   internal sealed class Configuration : DbMigrationsConfiguration<SportsStoreDomailLibrary.Concrete.clsSportsStoreDBContext>
    {
        ...
        protected override void Seed(SportsStoreDomailLibrary.Concrete.clsSportsStoreDBContext context)
        {
